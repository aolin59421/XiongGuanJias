...
- (id)initWithFrame:(CGRect)frame {
    if(self = [super initWithFrame:frame]) {
        ...
        self.titles = [NSMutableArray arrayWithObjects:@"下拉刷新"/*NSLocalizedString(@"Pull to refresh...",)*/,
                             @"释放加载"/*NSLocalizedString(@"Release to refresh...",)*/,
                             @"加载中..."/*NSLocalizedString(@"Loading...",)*/,
                                nil];
