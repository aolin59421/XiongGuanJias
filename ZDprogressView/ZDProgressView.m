...
//    self.borderWidth = 1;
    ...
    self.twoView = [[UIImageView alloc] init];
    ...
    self.oneView = [[UIImageView alloc] init];
...
{
    self.twoView.image = _progressImage;
}

- (void)setTintImage:(UIImage *)image
{
    self.oneView.image = _TintImage;
}
